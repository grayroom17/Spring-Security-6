...
insert into transaction (uuid, account_id, customer_id, transaction_date, transaction_summary, transaction_type, transaction_amt, closing_balance, created_at)
values (gen_random_uuid(), 1, 1, now() - interval '7 day', 'coffee shop', 'withdrawal', 30, 34500, now() - interval '7 day'),
       (gen_random_uuid(), 1, 1, now() - interval '6 day', 'uber', 'withdrawal', 100, 34400, now() - interval '6 day'),
       (gen_random_uuid(), 1, 1, now() - interval '5 day', 'self deposit', 'deposit', 500, 34900, now() - interval '5 day'),
       (gen_random_uuid(), 1, 1, now() - interval '4 day', 'ebay', 'withdrawal', 600, 34300, now() - interval '4 day'),
       (gen_random_uuid(), 1, 1, now() - interval '2 day', 'onlinetransfer', 'deposit', 700, 35000, now() - interval '2 day'),
       (gen_random_uuid(), 1, 1, now() - interval '1 day', 'amazon.com', 'withdrawal', 100, 34900, now() - interval '1 day');
